...
from c_basicsr.data import gaussian_kernels as gaussian_kernels
from c_basicsr.data.transforms import augment
from c_basicsr.data.data_util import paths_from_folder, brush_stroke_mask, random_ff_mask
from c_basicsr.utils import FileClient, get_root_logger, imfrombytes, img2tensor
from c_basicsr.utils.registry import DATASET_REGISTRY
...
class FFHQBlindDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if self.use_motion_kernel:
            ...
            motion_kernel_path = opt.get('motion_kernel_path', 'c_basicsr/data/motion-blur-kernels-32.pth')
