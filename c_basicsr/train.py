...
from c_basicsr.data import build_dataloader, build_dataset
from c_basicsr.data.data_sampler import EnlargedSampler
from c_basicsr.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from c_basicsr.models import build_model
from c_basicsr.utils import (MessageLogger, check_resume, get_env_info, get_root_logger, init_tb_logger,
                           init_wandb_logger, make_exp_dirs, mkdir_and_rename, set_random_seed)
from c_basicsr.utils.dist_util import get_dist_info, init_dist
from c_basicsr.utils.options import dict2str, parse
...
def init_loggers(opt):
    ...
    logger = get_root_logger(logger_name='c_basicsr', log_level=logging.INFO, log_file=log_file)
